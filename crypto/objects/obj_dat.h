...
/* Serialized OID's */
static const unsigned char so[8015] = {
    ...
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x07,  /* [ 7859] OBJ_picnicl1full */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x08,  /* [ 7870] OBJ_p256_picnicl1full */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x09,  /* [ 7881] OBJ_rsa3072_picnicl1full */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x15,  /* [ 7892] OBJ_picnic3l1 */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x16,  /* [ 7903] OBJ_p256_picnic3l1 */
    0x2B,0x06,0x01,0x04,0x01,0x82,0x37,0x59,0x02,0x01,0x17,  /* [ 7914] OBJ_rsa3072_picnic3l1 */
    0x2B,0xCE,0x0F,0x05,0x01,0x01,0x01,            /* [ 7925] OBJ_rainbowIclassic */
    0x2B,0xCE,0x0F,0x05,0x01,0x02,0x01,            /* [ 7932] OBJ_p256_rainbowIclassic */
    0x2B,0xCE,0x0F,0x05,0x01,0x03,0x01,            /* [ 7939] OBJ_rsa3072_rainbowIclassic */
    0x2B,0xCE,0x0F,0x05,0x03,0x01,0x01,            /* [ 7946] OBJ_rainbowVclassic */
    0x2B,0xCE,0x0F,0x05,0x03,0x02,0x01,            /* [ 7953] OBJ_p521_rainbowVclassic */
    0x2B,0xCE,0x0F,0x06,0x01,0x01,                 /* [ 7960] OBJ_sphincsharaka128frobust */
    0x2B,0xCE,0x0F,0x06,0x01,0x02,                 /* [ 7966] OBJ_p256_sphincsharaka128frobust */
    0x2B,0xCE,0x0F,0x06,0x01,0x03,                 /* [ 7972] OBJ_rsa3072_sphincsharaka128frobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x01,                 /* [ 7978] OBJ_sphincssha256128frobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x02,                 /* [ 7984] OBJ_p256_sphincssha256128frobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x03,                 /* [ 7990] OBJ_rsa3072_sphincssha256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x01,                 /* [ 7996] OBJ_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x02,                 /* [ 8002] OBJ_p256_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x03,                 /* [ 8008] OBJ_rsa3072_sphincsshake256128frobust */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"picnicl1full", "picnicl1full", NID_picnicl1full, 11, &so[7859]},
    {"p256_picnicl1full", "p256_picnicl1full", NID_p256_picnicl1full, 11, &so[7870]},
    {"rsa3072_picnicl1full", "rsa3072_picnicl1full", NID_rsa3072_picnicl1full, 11, &so[7881]},
    {"picnic3l1", "picnic3l1", NID_picnic3l1, 11, &so[7892]},
    {"p256_picnic3l1", "p256_picnic3l1", NID_p256_picnic3l1, 11, &so[7903]},
    {"rsa3072_picnic3l1", "rsa3072_picnic3l1", NID_rsa3072_picnic3l1, 11, &so[7914]},
    {"rainbowIclassic", "rainbowIclassic", NID_rainbowIclassic, 7, &so[7925]},
    {"p256_rainbowIclassic", "p256_rainbowIclassic", NID_p256_rainbowIclassic, 7, &so[7932]},
    {"rsa3072_rainbowIclassic", "rsa3072_rainbowIclassic", NID_rsa3072_rainbowIclassic, 7, &so[7939]},
    {"rainbowVclassic", "rainbowVclassic", NID_rainbowVclassic, 7, &so[7946]},
    {"p521_rainbowVclassic", "p521_rainbowVclassic", NID_p521_rainbowVclassic, 7, &so[7953]},
    {"sphincsharaka128frobust", "sphincsharaka128frobust", NID_sphincsharaka128frobust, 6, &so[7960]},
    {"p256_sphincsharaka128frobust", "p256_sphincsharaka128frobust", NID_p256_sphincsharaka128frobust, 6, &so[7966]},
    {"rsa3072_sphincsharaka128frobust", "rsa3072_sphincsharaka128frobust", NID_rsa3072_sphincsharaka128frobust, 6, &so[7972]},
    {"sphincssha256128frobust", "sphincssha256128frobust", NID_sphincssha256128frobust, 6, &so[7978]},
    {"p256_sphincssha256128frobust", "p256_sphincssha256128frobust", NID_p256_sphincssha256128frobust, 6, &so[7984]},
    {"rsa3072_sphincssha256128frobust", "rsa3072_sphincssha256128frobust", NID_rsa3072_sphincssha256128frobust, 6, &so[7990]},
    {"sphincsshake256128frobust", "sphincsshake256128frobust", NID_sphincsshake256128frobust, 6, &so[7996]},
    {"p256_sphincsshake256128frobust", "p256_sphincsshake256128frobust", NID_p256_sphincsshake256128frobust, 6, &so[8002]},
    {"rsa3072_sphincsshake256128frobust", "rsa3072_sphincsshake256128frobust", NID_rsa3072_sphincsshake256128frobust, 6, &so[8008]},
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1091,    /* "n3" */
     ...
     139,    /* "nsSGC" */
      77,    /* "nsSslServerName" */
    1255,    /* "ntru_hps2048509" */
    1257,    /* "ntru_hps2048677" */
    1259,    /* "ntru_hps4096821" */
    1261,    /* "ntru_hrss701" */
    1301,    /* "ntrulpr653" */
    1303,    /* "ntrulpr761" */
    1305,    /* "ntrulpr857" */
     681,    /* "onBasis" */
    1231,    /* "oqs_kem_default" */
    ...
    1141,    /* "oscca" */
     475,    /* "otherMailbox" */
     876,    /* "owner" */
    1246,    /* "p256_bike1l1cpa" */
    1286,    /* "p256_bike1l1fo" */
    1199,    /* "p256_dilithium2" */
    1202,    /* "p256_dilithium3" */
    1207,    /* "p256_falcon512" */
    1234,    /* "p256_frodo640aes" */
    1236,    /* "p256_frodo640shake" */
    1296,    /* "p256_hqc128" */
    1250,    /* "p256_kyber512" */
    1290,    /* "p256_kyber90s512" */
    1264,    /* "p256_lightsaber" */
    1256,    /* "p256_ntru_hps2048509" */
    1302,    /* "p256_ntrulpr653" */
    1232,    /* "p256_oqs_kem_default" */
    1196,    /* "p256_oqs_sig_default" */
    1215,    /* "p256_picnic3l1" */
    1212,    /* "p256_picnicl1full" */
    1218,    /* "p256_rainbowIclassic" */
    1270,    /* "p256_sidhp434" */
    1272,    /* "p256_sidhp503" */
    1278,    /* "p256_sikep434" */
    1280,    /* "p256_sikep503" */
    1308,    /* "p256_sntrup653" */
    1223,    /* "p256_sphincsharaka128frobust" */
    1226,    /* "p256_sphincssha256128frobust" */
    1229,    /* "p256_sphincsshake256128frobust" */
    1248,    /* "p384_bike1l3cpa" */
    1288,    /* "p384_bike1l3fo" */
    1205,    /* "p384_dilithium4" */
    1238,    /* "p384_frodo976aes" */
    1240,    /* "p384_frodo976shake" */
    1298,    /* "p384_hqc192" */
    1252,    /* "p384_kyber768" */
    1292,    /* "p384_kyber90s768" */
    1258,    /* "p384_ntru_hps2048677" */
    1262,    /* "p384_ntru_hrss701" */
    1304,    /* "p384_ntrulpr761" */
    1306,    /* "p384_ntrulpr857" */
    1266,    /* "p384_saber" */
    1274,    /* "p384_sidhp610" */
    1282,    /* "p384_sikep610" */
    1310,    /* "p384_sntrup761" */
    ...
    1268,    /* "p521_firesaber" */
    1242,    /* "p521_frodo1344aes" */
    1244,    /* "p521_frodo1344shake" */
    1300,    /* "p521_hqc256" */
    1254,    /* "p521_kyber1024" */
    1294,    /* "p521_kyber90s1024" */
    1260,    /* "p521_ntru_hps4096821" */
    1221,    /* "p521_rainbowVclassic" */
    1276,    /* "p521_sidhp751" */
    1284,    /* "p521_sikep751" */
    ...
    1033,    /* "pkInitKDC" */
     ...
     450,    /* "rFC822localPart" */
    1217,    /* "rainbowIclassic" */
    1220,    /* "rainbowVclassic" */
    ...
    1216,    /* "rsa3072_picnic3l1" */
    1213,    /* "rsa3072_picnicl1full" */
    1219,    /* "rsa3072_rainbowIclassic" */
    1224,    /* "rsa3072_sphincsharaka128frobust" */
    1227,    /* "rsa3072_sphincssha256128frobust" */
    1230,    /* "rsa3072_sphincsshake256128frobust" */
       6,    /* "rsaEncryption" */
    ...
    1309,    /* "sntrup761" */
    1311,    /* "sntrup857" */
    1222,    /* "sphincsharaka128frobust" */
    1225,    /* "sphincssha256128frobust" */
    1228,    /* "sphincsshake256128frobust" */
     660,    /* "street" */
      85,    /* "subjectAltName" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1222,    /* OBJ_sphincsharaka128frobust      1 3 9999 6 1 1 */
    1223,    /* OBJ_p256_sphincsharaka128frobust 1 3 9999 6 1 2 */
    1224,    /* OBJ_rsa3072_sphincsharaka128frobust 1 3 9999 6 1 3 */
    1225,    /* OBJ_sphincssha256128frobust      1 3 9999 6 4 1 */
    1226,    /* OBJ_p256_sphincssha256128frobust 1 3 9999 6 4 2 */
    1227,    /* OBJ_rsa3072_sphincssha256128frobust 1 3 9999 6 4 3 */
    1228,    /* OBJ_sphincsshake256128frobust    1 3 9999 6 7 1 */
    1229,    /* OBJ_p256_sphincsshake256128frobust 1 3 9999 6 7 2 */
    1230,    /* OBJ_rsa3072_sphincsshake256128frobust 1 3 9999 6 7 3 */
    ...
    1217,    /* OBJ_rainbowIclassic              1 3 9999 5 1 1 1 */
    1218,    /* OBJ_p256_rainbowIclassic         1 3 9999 5 1 2 1 */
    1219,    /* OBJ_rsa3072_rainbowIclassic      1 3 9999 5 1 3 1 */
    1220,    /* OBJ_rainbowVclassic              1 3 9999 5 3 1 1 */
    1221,    /* OBJ_p521_rainbowVclassic         1 3 9999 5 3 2 1 */
    ...
    1211,    /* OBJ_picnicl1full                 1 3 6 1 4 1 311 89 2 1 7 */
    1212,    /* OBJ_p256_picnicl1full            1 3 6 1 4 1 311 89 2 1 8 */
    1213,    /* OBJ_rsa3072_picnicl1full         1 3 6 1 4 1 311 89 2 1 9 */
    1214,    /* OBJ_picnic3l1                    1 3 6 1 4 1 311 89 2 1 21 */
    1215,    /* OBJ_p256_picnic3l1               1 3 6 1 4 1 311 89 2 1 22 */
    1216,    /* OBJ_rsa3072_picnic3l1            1 3 6 1 4 1 311 89 2 1 23 */
